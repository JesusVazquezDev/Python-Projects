...
iv = ciphertextWithTag[:16] # First 16 bits/bytes? 
ciphertext = ciphertextWithTag[:len(ciphertextWithTag)-32]  # with iv # First 32 bits/bytes 
tag = ciphertextWithTag[len(ciphertextWithTag)-32:] # Last 32 bits/bytes 
